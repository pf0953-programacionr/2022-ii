...
Bivand, R. (2022). *CRAN Task View: Analysis of Spatial Data*. [https://CRAN.R-project.org/view=Spatial](https://CRAN.R-project.org/view=Spatial)

R-Ladies Madrid. (2021). *R-Ladies Madrid (español)---Analiza datos espaciales---Stephanie Orellana*. [https://www.youtube.com/watch?v=59tO2ARvVVU](https://www.youtube.com/watch?v=59tO2ARvVVU)