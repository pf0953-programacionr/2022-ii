...
### Tutoriales
Abba, I. V. (2021). *Git and GitHub Tutorial -- Version Control for Beginners*. FreeCodeCamp.Org. [https://www.freecodecamp.org/news/git-and-github-for-beginners/](https://www.freecodecamp.org/news/git-and-github-for-beginners/)
...
1. Realice un _fork_ a su cuenta en GitHub del repositorio localizado en la dirección [https://github.com/pf0953-programacionr/2022-ii-tutorial-git-repo-ejemplo](https://github.com/pf0953-programacionr/2022-ii-tutorial-git-repo-ejemplo). Obtendrá un repositorio llamado "https://github.com/[nombre-usuario]/2022-ii-tutorial-git-repo-ejemplo", en donde [nombre-usuario] es su nombre de usuario en GitHub.
